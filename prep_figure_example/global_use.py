...
class omni_dataset:
    ...
    def omni_stats(self):
            if self.omni_cache is None:
                ...
                if self.start_date<date(year=2018,month=3,day=1):
                ...
                elif date(year=2018,month=3,day=1)<self.start_date<date(year=2018,month=12,day=31):
                    start_d = str(self.start_date.strftime("%Y-%m-%d"))
                    
                    no_days = self.end_date - self.start_date
                    no_days = int(no_days.days)
                
                    omni_file = '/data/emfisis_burst/wip/rablack75/rablack75/full_plasmapause_stats/omni20180301_20190101.txt'
                    file_format = '/data/emfisis_burst/wip/rablack75/rablack75/full_plasmapause_stats/omni_20180301_20190101_fmt'
                    f_format = open(f'{file_format}.txt',"r")
                    ...
                    omni_file = '/data/emfisis_burst/wip/rablack75/rablack75/full_plasmapause_stats/omni_20190101_20191014.txt'
                    file_format = '/data/emfisis_burst/wip/rablack75/rablack75/full_plasmapause_stats/omni_20180301_20190101_fmt'
                    f_format = open(f'{file_format}.txt',"r")
    ...
    def Kp(self):
        ...
        kp_data = getKpindex(self.start_date,self.end_date,'Kp')
        Kp = kp_data[1]
        Kp_epoch = kp_data[0]
...
class AccessSurveyAttrs:
    ...
    def clean_data(self, flag):
        ...
        eclipse_t = self.get_badtimes("/data/emfisis_burst/wip/rablack75/BackReduction/rbsp-b_eclipse_times.txt")
        thruster_t = self.get_badtimes("/data/emfisis_burst/wip/rablack75/BackReduction/rbsp-b_thruster_firing_times.txt")
        charging_t = self.get_badtimes("/data/emfisis_burst/wip/rablack75/BackReduction/rbsp-b_charging_times.txt")
